set(_PKG_CMAKE_PATH ${THIRD_PARTY_DIR}/grpc/lib/cmake)

set(absl_DIR ${_PKG_CMAKE_PATH}/absl)
set(utf8_range_DIR ${_PKG_CMAKE_PATH}/utf8_range)
set(Protobuf_DIR ${_PKG_CMAKE_PATH}/protobuf)
set(gRPC_DIR ${_PKG_CMAKE_PATH}/grpc)

# message(STATUS "DIR: ${re2_DIR}")
